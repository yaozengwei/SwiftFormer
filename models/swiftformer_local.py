...
@register_model
def SwiftFormer_XS_local(pretrained=False, **kwargs):
    model = SwiftFormer(
...
@register_model
def SwiftFormer_S_local(pretrained=False, **kwargs):
    model = SwiftFormer(
...
@register_model
def SwiftFormer_L1_local(pretrained=False, **kwargs):
    model = SwiftFormer(
...
@register_model
def SwiftFormer_L3_local(pretrained=False, **kwargs):
    model = SwiftFormer(
